"""
Production settings for retro_game_web project.
...
# Azure App Service and allowed hosts
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1').split(',')

# Add Azure App Service hostname if running on Azure
...
# Database
# Use DATABASE_URL if available (for production), otherwise SQLite
...
# Simplified static file serving for containers
